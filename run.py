...
parser.add_argument('--model', type=str, default='TimeKAN',
                    help='model name, options:[PatchTST, DLinear, Autoformer, Informer, Transformer, FEDformer, Fedformer, iTransformer, xPatch, PDF, TimeMixer, TimeKAN, TimesNet, FilterTS, Fredformer]')
parser.add_argument('--task_name', type=str, default='long_term_forecast', help='task name')
# data loader
parser.add_argument('--data', type=str, default='custom', help='dataset type')
parser.add_argument('--root_path', type=str, default='./dataset', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='ETTh1.csv', help='data file') # CHANGED, using to get "data"
parser.add_argument('--features', type=str, default='M',
                    help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate,\
                        S:univariate predict univariate, MS:multivariate predict univariate, usually M\
                        在dataloader时, S只保留OT, 另外两个除了时间都保留')
parser.add_argument('--target', type=str, default='OT', help='target feature in S or MS task, OT means last one, always')
parser.add_argument('--freq', type=str, default='h',\
                    help="freq for time features encoding,\
                    options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly],\
                    you can also use more detailed freq like 15min or 3h\
                     in [from pandas.tseries.frequencies import to_offset] initially embedding, not be used")
...
# PatchTST
parser.add_argument('--fc_dropout', type=float, default=0.00, help='fully connected dropout')
...
parser.add_argument('--cap', type=float, default=30.0, help='data cap for each channel')
...
for ii in range(args.itr):
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(\
        args.model_id, args.model, args.features, args.seq_len, args.label_len, args.pred_len, args.d_model,\
        args.n_heads, args.e_layers, args.d_layers, args.d_ff, args.factor, args.embed, args.distil, args.des, ii)
